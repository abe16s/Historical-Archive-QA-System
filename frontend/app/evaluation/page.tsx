          ...
          <div className="flex gap-4">
            <label className="flex items-center">
              <input
                ...
                className="mr-2"
              />
              <span className="text-sm text-black">Manual Evaluation</span>
            </label>
            <label className="flex items-center">
              <input
                type="radio"
                ...
                className="mr-2"
              />
              <span className="text-sm text-black">Chat Evaluation</span>
            </label>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-black bg-white text-black"
              rows={3}
              disabled={loading}
            />
          </div>
            ...
            <>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-black bg-white text-black font-mono text-sm"
                  rows={6}
                  disabled={loading}
                />
          ...
          <button
            ...
            className="w-full px-6 py-3 bg-black text-white rounded-lg hover:bg-gray-800 disabled:opacity-50 disabled:cursor-not-allowed font-medium"
          >
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-lg shadow p-6 border border-gray-300">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="bg-gray-50 rounded-lg p-4 space-y-2 border border-gray-300">
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-medium text-black">{result.metrics.citation_accuracy.total_citations}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-600">Valid Citations:</span>
                    <span className="font-medium text-black">{result.metrics.citation_accuracy.valid_citations}</span>
                  </div>
                  {result.metrics.citation_accuracy.missing_sources.length > 0 && (
                    <div className="mt-2">
                      <p className="text-sm font-medium text-black mb-1">Missing Sources:</p>
                  ...
                  {result.metrics.citation_accuracy.invalid_citations.length > 0 && (
                    <div className="mt-2">
                      <p className="text-sm font-medium text-black mb-1">Invalid Citations:</p>
                      <ul className="list-disc list-inside text-sm text-gray-600">
              ...
              <div>
                ...
                <div className="bg-gray-50 rounded-lg p-4 space-y-2 border border-gray-300">
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-medium text-black">{formatScore(result.metrics.context_relevance.average_similarity)}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-600">Min Similarity:</span>
                    <span className="font-medium text-black">{formatScore(result.metrics.context_relevance.min_similarity)}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-600">Max Similarity:</span>
                    <span className="font-medium text-black">{formatScore(result.metrics.context_relevance.max_similarity)}</span>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="bg-gray-50 rounded-lg p-4 space-y-2 border border-gray-300">
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-600">Supported Claims:</span>
                    <span className="font-medium text-black">{result.metrics.answer_faithfulness.supported_claims} / {result.metrics.answer_faithfulness.total_claims}</span>
                  </div>
                  {result.metrics.answer_faithfulness.unsupported_claims.length > 0 && (
                    <div className="mt-2">
                      <p className="text-sm font-medium text-black mb-1">Unsupported Claims:</p>
                      <ul className="list-disc list-inside text-sm text-gray-600">
          ...
          <div className="bg-white rounded-lg shadow p-6 border border-gray-300">
            ...
            <div className="bg-gray-50 rounded-lg p-4 border border-gray-300">
              <p className="text-black whitespace-pre-wrap">{result.answer}</p>
            </div>
          </div>
        </div>
      )}
